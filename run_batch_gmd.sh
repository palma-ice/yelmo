...
jobrun ./runylmo -s -q short -w 24 -e mismip -n par-gmd/yelmo_MISMIP3D.nml -- -o ${fldr}/mismip/default -p ydyn.beta_gl_scale=0 ydyn.beta_gl_stag=0 mismip.dx=10.0,20.0
jobrun ./runylmo -s -q short -w 24 -e mismip -n par-gmd/yelmo_MISMIP3D.nml -- -o ${fldr}/mismip/subgrid -p ydyn.beta_gl_scale=0 ydyn.beta_gl_stag=3 mismip.dx=10.0,20.0
